<?php
    ...
    if (!empty($_POST)) {
        ...
        try{
            User::updateUser($email, $username, $education, $bio);
        ...
        <main>
            ...
            <form method="post" action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>>
                ...
                <div class="mb-3">
                    ...
                    value="<?php echo htmlentities($result->education); ?>">
                </div>

                <div class="mb-3">
                    <label for="bio" class="form-label">bio</label>
                    <textarea type="bio" name="bio" class="form-control" id="bio" cols="60" row="30"></textarea
